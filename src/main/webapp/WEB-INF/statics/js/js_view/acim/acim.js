...
*/
		...
		if((ifMainCatalog_temp=="yes" &&  hasSubCatalog_temp =="yes") ){
			...
			catalogHtml +="<li>" +
			 ...
			 '<a  href="#text'+ catalogId_temp +'">'+ catalogName_temp  + ' ['+ miraclePages_temp +']' +'</a><i class="fa fa-chevron-down"></i></div>'+
		       '<ul class="submenu">';
			...
			catalogHtml +="<li>" +
			'<div class="link" href="#text'+ catalogId_temp +'" id="'+ catalogId_temp+'"> <a  href="#text'+ catalogId_temp +'">'+ catalogName_temp + ' ['+ miraclePages_temp +']' +'</a><i class="fa fa-chevron-down"></i></div>'+
            '</li>';
			...
			catalogHtml +=
			 '<li>'+
             '<div  id="'+ catalogId_temp +'" class="link"> <a  href="#text'+ catalogId_temp +'" >'+ catalogName_temp  + ' ['+ miraclePages_temp +']' +' </a><i class="fa fa-chevron-down"></i></div>'+
                '<ul class="submenu" >';
